      ...
      <section className="section space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {['/carte.jpg', '/salon1.jpg', '/cuirjet.jpg'].map((src, i) => (
            <div
              key={i}
              className="relative h-40 sm:h-56 rounded-xl border border-white/10 overflow-hidden"
            >
              <Image
                src={src}
                alt="Kaura"
        ...
        <blockquote className="card [font-family:var(--font-playfair)] text-lg leading-snug">
